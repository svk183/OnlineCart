...
function generateFiles(options) {
    return () => {
        ...
        return schematics_1.mergeWith(schematics_1.apply(schematics_1.url('./files'), [
            schematics_1.template(Object.assign({ tmpl: '' }, options, { ext: options.js ? 'js' : 'ts', offsetFromRoot: workspace_2.offsetFromRoot(options.projectRoot) })),
...
function normalizeOptions(options) {
    ...
    return Object.assign({}, options, { projectName,
        projectRoot });
}
