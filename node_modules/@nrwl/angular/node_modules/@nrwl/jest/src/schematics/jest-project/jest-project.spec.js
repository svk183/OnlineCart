...
describe('jestProject', () => {
    ...
    it('should alter workspace.json', () => __awaiter(this, void 0, void 0, function* () {
        const resultTree = yield testing_2.runSchematic('jest-project', {
            project: 'lib1',
            setupFile: 'angular'
        }, appTree);
    ...
    it('should create a jest.config.js', () => __awaiter(this, void 0, void 0, function* () {
        const resultTree = yield testing_2.runSchematic('jest-project', {
            project: 'lib1'
        }, appTree);
...
`);
    ...
    it('should update the local tsconfig.json', () => __awaiter(this, void 0, void 0, function* () {
        const resultTree = yield testing_2.runSchematic('jest-project', {
            project: 'lib1'
        }, appTree);
    ...
    it('should create a tsconfig.spec.json', () => __awaiter(this, void 0, void 0, function* () {
        const resultTree = yield testing_2.runSchematic('jest-project', {
            project: 'lib1',
            setupFile: 'angular'
        }, appTree);
    ...
    describe('--setup-file', () => {
        it('should generate src/test-setup.ts', () => __awaiter(this, void 0, void 0, function* () {
            const resultTree = yield testing_2.runSchematic('jest-project', {
                project: 'lib1',
                setupFile: 'none'
            }, appTree);
        ...
        it('should not list the setup file in workspace.json', () => __awaiter(this, void 0, void 0, function* () {
            const resultTree = yield testing_2.runSchematic('jest-project', {
                project: 'lib1',
                setupFile: 'none'
            }, appTree);
        ...
        it('should not list the setup file in tsconfig.spec.json', () => __awaiter(this, void 0, void 0, function* () {
            const resultTree = yield testing_2.runSchematic('jest-project', {
                project: 'lib1',
                setupFile: 'none'
            }, appTree);
    ...
    describe('--skip-serializers', () => {
        it('should not list the serializers in jest.config.js', () => __awaiter(this, void 0, void 0, function* () {
            const resultTree = yield testing_2.runSchematic('jest-project', {
                project: 'lib1',
...
`);
    ...
    describe('--support-tsx', () => {
        it('should add tsx to moduleExtensions', () => __awaiter(this, void 0, void 0, function* () {
            const resultTree = yield testing_2.runSchematic('jest-project', {
                project: 'lib1',
                supportTsx: true
            }, appTree);
