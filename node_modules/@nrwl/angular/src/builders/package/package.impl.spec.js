...
const workspaceUtils = require("@nrwl/workspace");
...
describe('AngularLibraryWebBuildBuilder', () => {
    ...
    it('should invoke ng-packagr for a libary without any dependencies', () => __awaiter(this, void 0, void 0, function* () {
    ...
    describe('with dependent libraries', () => {
        ...
        it('should properly set the TSConfig paths', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should update the package.json', () => __awaiter(this, void 0, void 0, function* () {
            spyOn(workspaceUtils, 'readJsonFile').and.returnValue({
                name: '@proj/buildable-child',
                version: '1.2.3'
            });
