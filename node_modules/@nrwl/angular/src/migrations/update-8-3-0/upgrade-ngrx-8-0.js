...
function updateCLI() {
    ...
    const rule = schematics_1.chain([
        ...
        (host, context) => {
            tasks.push(context.addTask(new tasks_1.NodePackageInstallTask()));
        }
    ]);
    return { rule, tasks };
}
    ...
    return (host) => {
        ...
        if (dependencies && dependencies['@ngrx/store']) {
            return schematics_1.chain([
                workspace_1.addUpdateTask('@ngrx/store', '8.1.0', updateDeps),
...
function default_1() {
    ...
    return schematics_1.chain([updateCLIRule, updateNgrx(tasks)]);
}
