...
export declare function pessimisticUpdate<T, A extends Action>(opts: PessimisticUpdateOpts<T, A>): (source: Observable<ActionOrActionWithState<T, A>>) => Observable<Action>;
export declare function optimisticUpdate<T, A extends Action>(opts: OptimisticUpdateOpts<T, A>): (source: Observable<ActionOrActionWithState<T, A>>) => Observable<Action>;
export declare function fetch<T, A extends Action>(opts: FetchOpts<T, A>): (source: Observable<ActionOrActionWithState<T, A>>) => Observable<Action>;
export declare function navigation<T, A extends Action>(component: Type<any>, opts: HandleNavigationOpts<T>): (source: Observable<ActionOrActionWithState<T, A>>) => Observable<Action>;
/**
