...
describe('app', () => {
    ...
    describe('not nested', () => {
        ...
        it('should remove the e2e target on the application', () => __awaiter(this, void 0, void 0, function* () {
            const tree = yield testing_2.runSchematic('app', { name: 'myApp' }, appTree);
            const workspaceJson = workspace_1.readJsonInTree(tree, '/workspace.json');
        ...
        it('should default the prefix to npmScope', () => __awaiter(this, void 0, void 0, function* () {
        ...
        xit('should work if the new project root is changed', () => __awaiter(this, void 0, void 0, function* () {
            appTree = yield testing_2.callRule(workspace_1.updateJsonInTree('/workspace.json', json => (Object.assign({}, json, { newProjectRoot: 'newProjectRoot' }))), appTree);
        ...
        it('should set projectType to application', () => __awaiter(this, void 0, void 0, function* () {
    ...
    describe('routing', () => {
        it('should include RouterTestingModule', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should not modify tests when --skip-tests is set', () => __awaiter(this, void 0, void 0, function* () {
    ...
    describe('template generation mode', () => {
        it('should create Nx specific `app.component.html` template', () => __awaiter(this, void 0, void 0, function* () {
            const tree = yield testing_2.runSchematic('app', { name: 'myApp', directory: 'myDir' }, appTree);
        ...
        it("should update `template`'s property of AppComponent with Nx content", () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should update the AppComponent spec to target Nx content', () => __awaiter(this, void 0, void 0, function* () {
            const tree = yield testing_2.runSchematic('app', { name: 'myApp', directory: 'myDir', inlineTemplate: true }, appTree);
    ...
    describe('--style scss', () => {
        it('should generate scss styles', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should set it as default', () => __awaiter(this, void 0, void 0, function* () {
            const result = yield testing_2.runSchematic('app', { name: 'myApp', style: 'scss' }, appTree);
    ...
    describe('--unit-test-runner karma', () => {
        it('should generate a karma config', () => __awaiter(this, void 0, void 0, function* () {
    ...
    describe('replaceAppNameWithPath', () => {
        it('should protect `workspace.json` commands and properties', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should protect `workspace.json` sensible properties value to be renamed', () => __awaiter(this, void 0, void 0, function* () {
    ...
    describe('--backend-project', () => {
        describe('with a backend project', () => {
            it('should add a proxy.conf.json to app', () => __awaiter(this, void 0, void 0, function* () {
        ...
        describe('with no backend project', () => {
            it('should not generate a proxy.conf.json', () => __awaiter(this, void 0, void 0, function* () {
    ...
    describe('--enable-ivy', () => {
        it('should not exclude files in the tsconfig.app.json', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should only include dts files in the tsconfig.app.json', () => __awaiter(this, void 0, void 0, function* () {
            const tree = yield testing_2.runSchematic('app', { name: 'my-app', enableIvy: true }, appTree);
            expect(tree.readContent('apps/my-app/tsconfig.app.json')).toContain(`\"include\": [\"src/**/*.d.ts\"]`);
        }));
    });
});
