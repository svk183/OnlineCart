...
function createComponentSpecFile({ projectName, libPath, componentName, componentPath, componentFileName }) {
    return (tree, context) => {
        const e2eLibIntegrationFolderPath = workspace_1.getProjectConfig(tree, projectName + '-e2e').sourceRoot + '/integration';
        const fullComponentPath = libPath + '/' + componentPath + '/' + componentFileName + '.ts';
