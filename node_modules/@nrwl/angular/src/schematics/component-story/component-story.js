...
function createComponentStoriesFile({ libPath, moduleFileName, ngModuleClassName, componentName, componentPath, componentFileName }) {
    return (tree, context) => {
        const relativeModulePath = componentPath
            .split('/')
        ...
        const props = getInputDescriptors(tree, libPath + '/' + componentPath + '/' + componentFileName + '.ts');
        return schematics_1.chain([
            schematics_1.mergeWith(schematics_1.apply(schematics_1.url('./files'), [
                ...
                schematics_1.move(libPath + '/' + componentPath)
            ]))
        ]);
    };
}
