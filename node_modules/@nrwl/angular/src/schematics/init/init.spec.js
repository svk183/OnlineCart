...
describe('init', () => {
    ...
    it('should add angular dependencies', () => __awaiter(this, void 0, void 0, function* () {
    ...
    describe('--unit-test-runner', () => {
        describe('karma', () => {
            it('should add karma dependencies', () => __awaiter(this, void 0, void 0, function* () {
            ...
            it('should add karma configuration', () => __awaiter(this, void 0, void 0, function* () {
                const tree = yield testing_1.runSchematic('init', {
                    unitTestRunner: 'karma'
                }, appTree);
                expect(tree.exists('karma.conf.js')).toBeTruthy();
            }));
            it('should set defaults', () => __awaiter(this, void 0, void 0, function* () {
                const tree = yield testing_1.runSchematic('init', {
                    unitTestRunner: 'karma'
                }, appTree);
        ...
        describe('jest', () => {
            it('should add jest dependencies', () => __awaiter(this, void 0, void 0, function* () {
                const tree = yield testing_1.runSchematic('init', {
                    unitTestRunner: 'jest'
                }, appTree);
                const { devDependencies } = workspace_1.readJsonInTree(tree, 'package.json');
            ...
            it('should add jest configuration', () => __awaiter(this, void 0, void 0, function* () {
                const tree = yield testing_1.runSchematic('init', {
                    unitTestRunner: 'jest'
                }, appTree);
    ...
    describe('--e2e-test-runner', () => {
        describe('cypress', () => {
            it('should add cypress dependencies', () => __awaiter(this, void 0, void 0, function* () {
                const tree = yield testing_1.runSchematic('init', {
                    unitTestRunner: 'none',
        ...
        describe('protractor', () => {
            it('should add protractor dependencies', () => __awaiter(this, void 0, void 0, function* () {
                const tree = yield testing_1.runSchematic('init', {
    ...
    describe('defaultCollection', () => {
        ...
        it('should be set if @nrwl/workspace was set before', () => __awaiter(this, void 0, void 0, function* () {
            appTree = yield testing_1.callRule(workspace_1.updateJsonInTree('workspace.json', json => {
                json.cli = {
