...
function updateNgPackage(options) {
    ...
    return schematics_1.chain([
        workspace_1.updateJsonInTree(`${options.projectRoot}/ng-package.json`, json => {
            ...
            return Object.assign({}, json, { dest,
                $schema });
        })
    ]);
}
      ...
      it('should create', () => {
        ...
        return schematics_1.chain([
            schematics_1.mergeWith(schematics_1.apply(schematics_1.url('./files/lib'), [
                schematics_1.template(Object.assign({}, options, { offsetFromRoot: workspace_1.offsetFromRoot(options.projectRoot) })),
            ...
            workspace_1.updateJsonInTree(workspace_1.getWorkspacePath(host), json => {
                ...
                if (options.style !== 'css') {
                    fixedProject.schematics = Object.assign({}, fixedProject.schematics, { '@nrwl/angular:component': {
            ...
            workspace_1.updateJsonInTree(`${options.projectRoot}/tsconfig.lib.json`, json => {
                ...
                return Object.assign({}, json, { extends: `./tsconfig.json`, compilerOptions: Object.assign({}, json.compilerOptions, { outDir: `${workspace_1.offsetFromRoot(options.projectRoot)}dist/out-tsc` }) });
            }),
            workspace_1.updateJsonInTree(`${options.projectRoot}/tslint.json`, json => {
                return Object.assign({}, json, { extends: `${workspace_1.offsetFromRoot(options.projectRoot)}tslint.json` });
            }),
...
function normalizeOptions(host, options) {
    ...
    return Object.assign({}, options, { prefix: options.prefix ? options.prefix : defaultPrefix, name: projectName, projectRoot, entryFile: 'index', moduleName,
        projectDirectory,
        modulePath,
        parsedTags,
        fileName });
