...
describe('lib', () => {
    ...
    describe('not nested', () => {
        it('should update ng-package.json', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should update ng-package.json $schema to the correct folder', () => __awaiter(this, void 0, void 0, function* () {
            const publishableTree = yield testing_2.runSchematic('lib', { name: 'myLib', framework: 'angular', publishable: true }, appTree);
            let ngPackage = workspace_1.readJsonInTree(publishableTree, 'libs/my-lib/ng-package.json');
            expect(ngPackage.$schema).toEqual('../../node_modules/ng-packagr/ng-package.schema.json');
        }));
        it('should not update package.json by default', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should update package.json when publishable', () => __awaiter(this, void 0, void 0, function* () {
            const tree = yield testing_2.runSchematic('lib', { name: 'myLib', framework: 'angular', publishable: true }, appTree);
            const packageJson = workspace_1.readJsonInTree(tree, '/package.json');
            expect(packageJson.devDependencies['ng-packagr']).toBeDefined();
        }));
        it("should update npmScope of lib's package.json when publishable", () => __awaiter(this, void 0, void 0, function* () {
            const tree = yield testing_2.runSchematic('lib', { name: 'myLib', framework: 'angular', publishable: true }, appTree);
        ...
        it('should remove "build" target from workspace.json when a library is not publishable', () => __awaiter(this, void 0, void 0, function* () {
        ...
        describe('when creating the tsconfig.lib.json', () => {
            it('should extend the local tsconfig.json', () => __awaiter(this, void 0, void 0, function* () {
                const tree = yield testing_2.runSchematic('lib', { name: 'myLib' }, appTree);
                const tsconfigJson = workspace_1.readJsonInTree(tree, 'libs/my-lib/tsconfig.lib.json');
                expect(tsconfigJson.extends).toEqual('./tsconfig.json');
            }));
            it('should exclude the test setup file when unitTestRunner is jest', () => __awaiter(this, void 0, void 0, function* () {
            ...
            it('should leave the excludes alone when unitTestRunner is karma', () => __awaiter(this, void 0, void 0, function* () {
            ...
            it('should remove the excludes when unitTestRunner is none', () => __awaiter(this, void 0, void 0, function* () {
    ...
    describe('router', () => {
        it('should error when lazy is set without routing', () => __awaiter(this, void 0, void 0, function* () {
            try {
        ...
        describe('lazy', () => {
            it('should add RouterModule.forChild', () => __awaiter(this, void 0, void 0, function* () {
                const tree = yield testing_2.runSchematic('lib', {
                    name: 'myLib',
                    directory: 'myDir',
                    framework: 'angular',
            ...
            it('should update the parent module', () => __awaiter(this, void 0, void 0, function* () {
                ...
                expect(moduleContents3).toContain(`
      {
        ...
        describe('eager', () => {
            it('should add RouterModule and define an array of routes', () => __awaiter(this, void 0, void 0, function* () {
                const tree = yield testing_2.runSchematic('lib', {
                    name: 'myLib',
                    directory: 'myDir',
                    framework: 'angular',
    ...
    describe('--unit-test-runner karma', () => {
        it('should generate karma configuration', () => __awaiter(this, void 0, void 0, function* () {
