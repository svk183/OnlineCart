...
describe('updateModuleName Rule', () => {
    ...
    it('should rename the module files and update the module name', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('should update any references to the module', () => __awaiter(this, void 0, void 0, function* () {
        tree = (yield testing_3.callRule(update_module_name_1.updateModuleName(schema), tree));
    ...
    it('should update the index.ts file which exports the module', () => __awaiter(this, void 0, void 0, function* () {
        tree = (yield testing_3.callRule(update_module_name_1.updateModuleName(schema), tree));
