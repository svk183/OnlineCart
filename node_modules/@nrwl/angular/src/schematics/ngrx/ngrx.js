...
function generateNgrxFilesFromTemplates(options) {
    ...
    const templateSource = schematics_1.apply(schematics_1.url(options.syntax === 'creators' ? './creator-files' : './files'), [
        ...
        schematics_1.template(Object.assign({}, options, { tmpl: '' }, workspace_1.names(name))),
...
function normalizeOptions(options) {
    return Object.assign({}, options, { directory: workspace_1.toFileName(options.directory) });
}
