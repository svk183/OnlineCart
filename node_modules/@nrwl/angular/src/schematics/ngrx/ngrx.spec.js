...
describe('ngrx', () => {
    ...
    it('should add empty root', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('should add empty root with minimal option', () => __awaiter(this, void 0, void 0, function* () {
        const tree = yield testing_2.runSchematic('ngrx', {
            name: 'state',
            module: 'apps/myapp/src/app/app.module.ts',
            root: true,
    ...
    it('should add root', () => __awaiter(this, void 0, void 0, function* () {
        const tree = yield testing_2.runSchematic('ngrx', {
            name: 'app',
            module: 'apps/myapp/src/app/app.module.ts',
            root: true
    ...
    it('should add facade to root', () => __awaiter(this, void 0, void 0, function* () {
        const tree = yield testing_2.runSchematic('ngrx', {
            name: 'app',
            module: 'apps/myapp/src/app/app.module.ts',
            root: true,
    ...
    it('should not add RouterStoreModule only if the module does not reference the router', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('should add feature', () => __awaiter(this, void 0, void 0, function* () {
        const tree = yield testing_2.runSchematic('ngrx', {
            name: 'state',
            module: 'apps/myapp/src/app/app.module.ts'
        }, appTree);
    ...
    it('should add with custom directoryName', () => __awaiter(this, void 0, void 0, function* () {
        const tree = yield testing_2.runSchematic('ngrx', {
            name: 'state',
            module: 'apps/myapp/src/app/app.module.ts',
    ...
    it('should only add files', () => __awaiter(this, void 0, void 0, function* () {
        const tree = yield testing_2.runSchematic('ngrx', {
            name: 'state',
            module: 'apps/myapp/src/app/app.module.ts',
            onlyAddFiles: true,
    ...
    it('should only add files with skipImport option', () => __awaiter(this, void 0, void 0, function* () {
        const tree = yield testing_2.runSchematic('ngrx', {
            name: 'state',
            module: 'apps/myapp/src/app/app.module.ts',
            onlyAddFiles: false,
    ...
    it('should error when no module is provided', () => __awaiter(this, void 0, void 0, function* () {
        try {
    ...
    it('should error the module could not be found', () => __awaiter(this, void 0, void 0, function* () {
        try {
            yield testing_2.runSchematic('ngrx', {
                name: 'state',
    ...
    describe('code generation', () => {
        it('should scaffold the ngrx "user" files without a facade', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should scaffold the ngrx "user" files WITH a facade', () => __awaiter(this, void 0, void 0, function* () {
            const appConfig = testing_2.getAppConfig();
            const hasFile = file => expect(tree.exists(file)).toBeTruthy();
        ...
        it('should build the ngrx actions', () => __awaiter(this, void 0, void 0, function* () {
            const appConfig = testing_2.getAppConfig();
        ...
        it('should build the ngrx selectors', () => __awaiter(this, void 0, void 0, function* () {
            const appConfig = testing_2.getAppConfig();
            const tree = yield buildNgrxTree(appConfig, 'users');
            const statePath = `${workspace_2.findModuleParent(appConfig.appModule)}/+state`;
        ...
        it('should build the ngrx facade', () => __awaiter(this, void 0, void 0, function* () {
            const appConfig = testing_2.getAppConfig();
        ...
        it('should build the ngrx reducer', () => __awaiter(this, void 0, void 0, function* () {
            const appConfig = testing_2.getAppConfig();
        ...
        it('should build the ngrx effects', () => __awaiter(this, void 0, void 0, function* () {
            const appConfig = testing_2.getAppConfig();
            const tree = yield buildNgrxTree(appConfig, 'users');
            const statePath = `${workspace_2.findModuleParent(appConfig.appModule)}/+state`;
...
import {
  ...
  UsersActionTypes
    ...
    describe('unit tests', () => {
        it('should produce proper specs for the ngrx reducer', () => __awaiter(this, void 0, void 0, function* () {
            const appConfig = testing_2.getAppConfig();
            const tree = yield buildNgrxTree(appConfig);
            const statePath = `${workspace_2.findModuleParent(appConfig.appModule)}/+state`;
        ...
        it('should update the barrel API with exports for ngrx facade, selector, and reducer', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should not update the barrel API with a facade', () => __awaiter(this, void 0, void 0, function* () {
            appTree = testing_2.createLib(appTree, 'flights');
            let libConfig = testing_2.getLibConfig();
            let tree = yield testing_2.runSchematic('ngrx', {
                name: 'super-users',
        ...
        it('should produce proper tests for the ngrx reducer for a name with a dash', () => __awaiter(this, void 0, void 0, function* () {
            const appConfig = testing_2.getAppConfig();
            const tree = yield testing_2.runSchematic('ngrx', {
                name: 'super-users',
    ...
    describe('creators syntax', () => {
        ...
        it('should generate a set of actions for the feature', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should generate a reducer for the feature', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should generate effects for the feature', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should generate selectors for the feature', () => __awaiter(this, void 0, void 0, function* () {
...
import {
  ...
  usersAdapter
        ...
        it('should generate a facade for the feature if enabled', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should generate a models file for the feature', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should use DataPersistence operators when useDataPersistence is set to false', () => __awaiter(this, void 0, void 0, function* () {
            appTree = schematics_1.Tree.empty();
            appTree = testing_3.createEmptyWorkspace(appTree);
            appTree = testing_2.createApp(appTree, 'myapp');
            const tree = yield testing_2.runSchematic('ngrx', {
        ...
        it('should re-export actions, state, and selectors using barrels if enabled', () => __awaiter(this, void 0, void 0, function* () {
            appTree = schematics_1.Tree.empty();
            appTree = testing_3.createEmptyWorkspace(appTree);
            appTree = testing_2.createApp(appTree, 'myapp');
