...
describe('schematic:stories', () => {
    ...
    describe('Storybook stories', () => {
        it('should generate stories.ts files', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should generate cypress spec files', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should run twice without errors', () => __awaiter(this, void 0, void 0, function* () {
            let tree = yield testing_1.runExternalSchematic('@nrwl/storybook', 'cypress-project', { name: 'test-ui-lib' }, appTree);
