...
describe('upgrade-module', () => {
    ...
    it('should update the bootstrap logic', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('should update package.json by default', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('should not package.json when --skipPackageJson=true', () => __awaiter(this, void 0, void 0, function* () {
        appTree.overwrite(`/package.json`, JSON.stringify({
            dependencies: {
                '@angular/core': '4.4.4'
            }
    ...
    it('should add router configuration when --router=true', () => __awaiter(this, void 0, void 0, function* () {
        const tree = yield testing_2.runSchematic('upgrade-module', {
            name: 'legacy',
            router: true,
            project: 'myapp'
    ...
    it('should support custom angularJsImport', () => __awaiter(this, void 0, void 0, function* () {
        const tree = yield testing_2.runSchematic('upgrade-module', {
            name: 'legacy',
