...
describe('schematic:cypress-project', () => {
    ...
    describe('Cypress Project', () => {
        ...
        it('should add update `workspace.json` file', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should add update `workspace.json` file properly when eslint is passed', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should set right path names in `cypress.json`', () => __awaiter(this, void 0, void 0, function* () {
            const tree = yield testing_2.runSchematic('cypress-project', { name: 'my-app-e2e', project: 'my-app' }, appTree);
        ...
        it('should set right path names in `tsconfig.e2e.json`', () => __awaiter(this, void 0, void 0, function* () {
            const tree = yield testing_2.runSchematic('cypress-project', { name: 'my-app-e2e', project: 'my-app' }, appTree);
