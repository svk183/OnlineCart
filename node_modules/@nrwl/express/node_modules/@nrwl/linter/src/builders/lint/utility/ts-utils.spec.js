...
describe('ts-utility', () => {
    ...
    it('should read and parse config file', () => {
        ...
        expect(ts.parseJsonConfigFileContent).toHaveBeenCalledWith('read-config-file', expect.objectContaining({
            fileExists: expect.any(Function),
            readDirectory: 'sys-dir',
            readFile: expect.any(Function),
            useCaseSensitiveFileNames: true
        }), 'proj-dir', { noEmit: true });
    });
    it('should throw an error if the config cannot be read', () => {
        ...
        expect(ts.formatDiagnostics).toHaveBeenCalledWith(['config err'], expect.anything());
    });
    it('should throw an error if there were relevant errors while parsing', () => {
        ...
        try {
            ...
            expect(ts.formatDiagnostics).toHaveBeenCalledWith([{ category: 'diag-categ-error', code: 1 }], expect.anything());
