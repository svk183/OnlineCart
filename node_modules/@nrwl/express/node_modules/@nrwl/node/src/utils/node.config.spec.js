...
describe('getNodePartial', () => {
    ...
    describe('the optimization option when true', () => {
        it('should not minify', () => {
            const result = node_config_1.getNodeWebpackConfig(Object.assign(Object.assign({}, input), { optimization: true }));
    ...
    describe('the externalDependencies option', () => {
        ...
        it('should change given module names to commonjs imports but not others', () => {
            const result = node_config_1.getNodeWebpackConfig(Object.assign(Object.assign({}, input), { externalDependencies: ['module1'] }));
            const callback = jest.fn();
        ...
        it('should not change any modules to commonjs imports', () => {
            const result = node_config_1.getNodeWebpackConfig(Object.assign(Object.assign({}, input), { externalDependencies: 'none' }));
