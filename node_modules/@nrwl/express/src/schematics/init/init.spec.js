...
describe('init', () => {
    ...
    it('should add dependencies', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield testing_2.callRule(workspace_1.addDepsToPackageJson({ '@nrwl/express': versions_1.expressVersion, [existing]: existingVersion }, { [existing]: existingVersion }, false), tree);
