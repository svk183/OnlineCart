...
describe('NodeBuildBuilder', () => {
    ...
    describe('run', () => {
        it('should call runWebpack', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should emit the outfile along with success', () => __awaiter(this, void 0, void 0, function* () {
            const run = yield architect.scheduleBuilder('@nrwl/node:build', testOptions);
        ...
        describe('webpackConfig option', () => {
            it('should require the specified function and use the return value', () => __awaiter(this, void 0, void 0, function* () {
